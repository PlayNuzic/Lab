...
const { inputLg, inputV, inputT, inputVUp, inputVDown, inputLgUp, inputLgDown,
        ...
        selectedToggleBtn, notationPanel, notationContent } = elements;
...
// Create preference storage for App5 (fixing previous bug: was using 'app2:' prefix)
const preferenceStorage = createPreferenceStorage({ prefix: 'app5', separator: ':' });
