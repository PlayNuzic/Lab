export function renderApp({ root, title, showSelectColor = false }) {
  ...
  role="img" aria-labelledby="tapTempoTitle tapTempoDesc"
>
  <title id="tapTempoTitle">Tap Tempo</title>
  <desc id="tapTempoDesc">Cercle de botó amb un dit que toca i ones de tap a sobre</desc>
  ...
  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24">
    ...
    <!-- Ones de tap (ripple) a sobre del dit -->
    <!-- Arc exterior -->
    <path d="M176 128a160 160 0 0 1 160 0" />
    <!-- Arc mitjà -->
    <path d="M200 156a120 120 0 0 1 112 0" />
    <!-- Arc interior -->
    <path d="M224 180a80 80 0 0 1 64 0" />

    <!-- Punt de tap (objectiu) -->
    <circle cx="256" cy="192" r="10" fill="currentColor" stroke="none"/>

    <!-- Dit (traç gruixut per destacar) -->
    <line x1="256" y1="360" x2="256" y2="200" stroke-width="48" />

    <!-- Palma simplificada (suport del dit) -->
    <path d="M256 360
             c 40 0 70 18 90 46
             M256 360
             c -40 0 -70 18 -90 46" />
