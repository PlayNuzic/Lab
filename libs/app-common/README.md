...
Capa middleware compartida per totes les apps del Lab. **54 mòduls** que centralitzen audio, DOM, controls de loop, fraction editor, visual sync, preferences i utilitats. Veure [CLAUDE.md](CLAUDE.md) per al mapa complet de mòduls per funcionalitat.
