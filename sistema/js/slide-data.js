...
<p><strong>Tip:</strong> Esta app combina el par N-iT, que es conceptualmente el par usado al escribir con notación musical.</p>`,
  ...
  17: {
    text: `<p>Hasta ahora hemos medido el tiempo en pulsos enteros: P(1 2 3...). Los pulsos enteros crean una velocidad constante (el BPM). Pero también hay música <strong>entre</strong> los pulsos. Para representar sonidos que ocurren dentro de un pulso entero, debemos añadir otra velocidad relativa al BPM. Lo hacemos subdividiendo el pulso en partes iguales. Para este fin usamos <b>fracciones simples</b> sobre los pulsos enteros.</p><p>Estas <b>fracciones simples</b> tienen siempre un 1 en el numerador y en el denominador un número entero que escojamos. El resultado serán pulsos más pequeños que irán más rápido que los pulsos enteros. La fracción 1/1 representa un pulso entero. La fracción 1/2 divide el paso en dos partes, 1/3 lo divide en tres partes, etc. Cuánto <b>mayor</b> sea el denominador, <b>más rápido</b> irán los nuevos pulsos.</p><p>Los <b>pulsos fraccionados (Pfr)</b> resultantes nos permiten realizar y componer ritmos muy variados con gran precisión.</p><p>Para numerar los pulsos fraccionados (<b>Pfr</b>), escribimos un punto después del pulso entero y seguidamente el número que corresponde a cada uno de los Pfr. Cada pulso fraccionado (<b>Pfr</b>) se identifica con un punto decimal: dentro del pulso entero <b>0</b> con fracción 1/3 tenemos <strong>0.1</strong> y <strong>0.2</strong> antes de llegar al pulso 1; dentro del pulso 1 tenemos <strong>1.1</strong> y <strong>1.2</strong>; y así sucesivamente. En una sucesión de pulsos, para abreviar podemos escribir solamente la parte decimal entre los pulsos enteros. Por ejemplo: "0" = pulso entero, ".1" = primera subdivisión, ".2" = segunda división.</p>
<p>Las fracciones simples siempre tienen el numerador fijado en 1. Son la manera más directa, pero no la única, de subdividir el tiempo.</p>`,
    tipsTitle: 'Prueba las fracciones simples',
    tips: `<p>CAL ACTUALITZAR.<br>Cambia el denominador de la fracción (1-8) con los botones <strong>+</strong> y <strong>-</strong> y observa cómo se divide cada paso en más o menos partes.</p>
