...
npm test           # Executa 76 test suites, 1500+ tests
...
tests/            — Tests d'integració + harness embed (76 suites, 1500+ tests)
```
...
```
app-common/          — Middleware: 54 mòduls (audio, DOM, loop, fraction-editor, ...)
...
**76 test suites, 1500+ tests** amb Jest 29.x. ES Modules amb Babel.
